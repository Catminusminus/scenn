...
constexpr auto make_dataset(scenn::Matrix<M, N, T>&& x, scenn::Matrix<M, O, U>&& y) {
  std::array<sprout::pair<scenn::Matrix<1, N, T>, scenn::Matrix<1, O, U>>, M> data;
...
struct Dataset {
  std::array<sprout::pair<scenn::Matrix<1, N, T>, scenn::Matrix<1, O, U>>, M> data;
  constexpr Dataset(std::array<sprout::pair<scenn::Matrix<1, N, T>, scenn::Matrix<1, O, U>>, M>&& data) : data(
    std::forward<std::array<sprout::pair<scenn::Matrix<1, N, T>, scenn::Matrix<1, O, U>>, M>>(data)) {};
  ...
  constexpr auto slice() const
  {
    ...
    return Dataset<J - I, N, O, T, U>(sprout::copy<std::array<sprout::pair<scenn::Matrix<1, N, T>,
    scenn::Matrix<1, O, U>>, J-I>, decltype(data.cbegin())>(
      data.cbegin() + I,
      data.cbegin() + J
    ));
  }
