...
int main() {
  ...
  constexpr Dataset dataset{make_matrix_from_array(std::move(x_arr)),
  ...
  constexpr Dataset dataset2{make_matrix_from_array(std::move(x_arr2)),
                             make_matrix_from_array(std::move(y_arr2))};
